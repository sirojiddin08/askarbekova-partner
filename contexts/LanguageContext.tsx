...
const translations: Record<Language, any> = {
    uz: {
        ...
        faq: {
            ...
            a2: "Ha, biz suddan oldingi bosqichda bepul dastlabki konsultatsiya taqdim etamiz. Bu sizga vaziyatingizni tushunish va to'g'ri qaror qabul qilishga yordam beradi.",
        ...
        contact: {
            ...
            subtitle: "Bepul konsultatsiya olish yoki savollaringizga javob olish uchun biz bilan bog'laning",
            phone: "Telefon",
            address: "Manzil",
    ...
    ru: {
        ...
        faq: {
            ...
            a2: "Да, мы предоставляем бесплатную первичную консультацию на досудебной стадии. Это поможет вам понять ситуацию и принять правильное решение.",
        ...
        contact: {
            ...
            subtitle: "Свяжитесь с нами для получения бесплатной консультации или ответов на ваши вопросы",
            phone: "Телефон",
            address: "Адрес",
            ...
            ctaDesc: "Первая консультация бесплатно. Звоните прямо сейчас!",
        },
        footer: {
    ...
    en: {
        ...
        faq: {
            ...
            a2: "Yes, we provide a free initial consultation at the pre-trial stage. This will help you understand the situation and make the right decision.",
        ...
        contact: {
            label: "Contact",
            title: "Contact Us",
            subtitle: "Contact us for a free consultation or to get answers to your questions",
            phone: "Phone",
            address: "Address",
            ...
            ctaDesc: "First consultation is free. Call now!",
        },
        footer: {
