...
const translations: Record<Language, any> = {
    uz: {
        ...
        contact: {
            ...
            phone: "Telefon",
            address: "Manzil",
            addressValue: "Alisher Navoiy koʻchasi, 5-uy, 3-xonadon",
            workHours: "Ish vaqti",
            workHoursValue: "Dush–Juma: 09:00–18:00",
            email: "Email",
            ...
            taxi: "Taksi",
            taxiDesc: "Ofisimizgacha taksi bilan boring",
            taxiYandex: "Yandex Go bilan",
            taxiUklon: "Uklon bilan",
    ...
    ru: {
        ...
        contact: {
            ...
            phone: "Телефон",
            address: "Адрес",
            addressValue: "ул. Алишера Навои, дом 5, кв. 3.",
            ...
            taxi: "Такси",
            taxiDesc: "Приезжайте к нам на такси",
            taxiYandex: "Через Yandex Go",
            taxiUklon: "Через Uklon",
    ...
    en: {
        ...
        contact: {
            ...
            phone: "Phone",
            address: "Address",
            addressValue: "Alisher Navoi Street, Building 5, Apartment 3.",
            ...
            taxi: "Taxi",
            taxiDesc: "Take a taxi to our office",
            taxiYandex: "Via Yandex Go",
            taxiUklon: "Via Uklon",
