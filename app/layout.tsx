...
export const metadata: Metadata = {
    ...
    title: {
        default:
            "Askarbekova Partner | Advokatlik Firmasi | Юридические услуги Ташкент",
        template: "%s | Askarbekova Partner — Advokat Toshkent",
    },
    description:
        "Toshkentdagi 35 yillik tajribaga ega professional advokatlik firmasi. Fuqarolik, jinoiy, iqtisodiy va ma'muriy ishlar bo'yicha yuridik himoya va sud vakiligi. Профессиональная адвокатская фирма в Ташкенте — защита по гражданским, уголовным, экономическим и административным делам.",
    keywords: [
        // O'zbek keywords
        "advokat",
        "advokat Toshkent",
        ...
        "iqtisodiy nizolar advokat",
        "jinoiy ish advokat",
        "fuqarolik ishi",
        "meros masalasi advokat",
        "ma'muriy nizolar",
        "biznes huquqiy yordam",
        "bepul yuridik konsultatsiya",
        "eng yaxshi advokat Toshkent",
        "advokat O'zbekiston",
        "Askarbekova Partner",
        "Askarbekova Partnyor",
    ...
    openGraph: {
        ...
        title:
            "Askarbekova Partner — Professional Advokatlik Firmasi Toshkent | Адвокатская фирма",
        description:
            "35 yillik tajribaga ega professional advokatlik firmasi. Fuqarolik, jinoiy, iqtisodiy va ma'muriy ishlar bo'yicha yuridik himoya. Профессиональная адвокатская фирма в Ташкенте.",
        images: [
            {
                url: "/og-image.jpg",
                width: 1200,
...
const jsonLdLegalService = {
    ...
    description:
        "Professional advokatlik firmasi — yuridik himoya, sud vakiligi va biznesni huquqiy qo'llab-quvvatlash. 35 yillik tajriba. Профессиональная адвокатская фирма в Ташкенте.",
    foundingDate: "1991",
    founder: {
        "@type": "Person",
